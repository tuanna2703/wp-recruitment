...
function cs_recent_post_carousel()
{
    if (function_exists('cms_allow_RegisterWidget')) {
        cms_allow_RegisterWidget('CS_Recent_Post_Carousel');
    }
}
...
class CS_Recent_Post_Carousel extends WP_Widget
{
    ...
    {
        parent::__construct(
            'cs_recent_post_carousel',
            esc_html__('CMS Recent Post', "wp-recruitment"),
            array('description' => esc_html__('Recent Posts Widget.', "wp-recruitment"), )
        );
    }
                        ...
                        <li class="item clearfix">
                            <div class="cms-recent-media">
                                <div class="image">
                                    ...
                                    <a class="post-featured-img <?php echo esc_attr($class); ?>" href="<?php the_permalink(); ?>"
                                        style="background-image: url(<?php echo esc_url($thumbnail); ?>)"></a>
                                </div>
                            </div>
                            <div class="cms-recent-details <?php if (has_post_thumbnail() == '') {
                                echo 'no-image';
                            } ?>">
    ...
    function form($instance)
    {
        ...
        <p>
            <label
                for="<?php echo '' . $this->get_field_id('title'); ?>"><?php esc_html_e('Title:', "wp-recruitment"); ?></label>
        ...
        <p>
            ...
            <input class="widefat" id="<?php echo '' . $this->get_field_id('extra_class'); ?>"
                ...
                value="<?php if (isset($instance['extra_class'])) {
                    echo esc_attr($instance['extra_class']);
                } ?>" />
        </p>
        <p>
            <label
                for="<?php echo '' . $this->get_field_id('number'); ?>"><?php esc_html_e('Number of post to show:', "wp-recruitment"); ?></label>
