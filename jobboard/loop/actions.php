...
if($opt_theme_options['job_listing_style'] == 'job-listing-classic' || $opt_theme_options['job_listing_style'] == 'job-listing-modern') { ?>
	<div class="loop-actions col-lg-3 col-md-12 col-sm-12 col-xs-12">
	    <?php do_action('jobboard_loop_actions'); ?>
	</div>
<?php } ?>

<?php if($opt_theme_options['job_listing_style'] == 'job-listing-outline') { ?>
