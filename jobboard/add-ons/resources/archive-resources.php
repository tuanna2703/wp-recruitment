...
$resources_title = recruitment_get_opt('resources_title', '');
$resources_description = recruitment_get_opt('resources_description', '');
?>
<?php get_header('jobboard'); ?>
<div class="jobboard-archive-loop jobboard-resources-wrap">
    <div class="container">
        <?php if (!empty($resources_title)): ?>
            <div class="jobboard-resources-heading">
                <h3><?php echo esc_html($resources_title); ?></h3>
                <p><?php echo esc_html($resources_description); ?></p>
            </div>
        <?php endif; ?>
                    ...
                    <div class="jr-item col-lg-6 col-md-6 col-sm-12 col-xs-12">
                        <div class="jr-item-inner">
                            <div class="jr-holder">
                                ...
                                <span class="jr-file-size">.<?php echo esc_attr($extension) ?>
                                    (<?php echo esc_attr($file_size_layout) ?>)</span>
                            ...
                            <form class="jr-action">
                                ...
                                <button class="jr-button-download"
                                    data-id="<?php echo get_the_ID() ?>"><?php echo esc_html__('Free Download', 'wp-recruitment') ?></button>
