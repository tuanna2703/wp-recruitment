...
<div id="cms-page-title" class="page-title jobboard-user-summary"<?php if($cover_image = jb_account_get_cover_image()){ echo ' style="background-image: url('.esc_url($cover_image).')"'; } ?>>
    <div class="container">
    <div class="row">
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
            <div class="summary-title">
                <span class="job-sub-title"><?php jb_account_the_type(); ?></span>
