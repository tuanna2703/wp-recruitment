...
<div class="user-contact">
    <h3><?php echo sprintf(esc_html__( 'Contact %s%s%s', 'wp-recruitment' ), '<span>', jb_account_get_display_name(), '</span>'); ?></h3>
    ...
    <div class="contact-address">
        <h4><?php esc_html_e('Address', 'wp-recruitment') ?></h4>
        <span><?php jb_account_the_location(); ?></span>
    </div>
    <div class="contact-email">
        <h4><?php esc_html_e('Email', 'wp-recruitment') ?></h4>
        <a href="mailto:<?php jb_account_the_email(); ?>"><?php jb_account_the_email(); ?></a>
    </div>
    <div class="contact-tel">
        <h4><?php esc_html_e('Call', 'wp-recruitment') ?></h4>
