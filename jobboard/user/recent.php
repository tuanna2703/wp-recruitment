...
<div class="user-recent">
    <h3><?php echo sprintf(esc_html__( 'Recent Jobs by %s%s%s', 'wp-recruitment' ), '<span>', jb_account_get_display_name(), '</span>'); ?></h3>
</div>
<div class="cms-recent-jobs style1">
    <div class="jb-jobs-body">
        <div class="jobboard-archive-loop">
            ...
            <?php else: ?>
                ...
                <?php esc_html_e('Recent Jobs Not Found!', 'wp-recruitment'); ?>
                </div>
            <?php endif; ?>
        </div>
    </div>
