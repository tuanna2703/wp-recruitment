...
switch ($atts['specialism_layout']) {
    case "layout1": ?>
        <div
            class="jb-specialism-list <?php echo esc_html($atts['job_style']); ?> <?php echo esc_html($atts['custom_class']); ?> clearfix">
                    ...
                    <div class="jb-specialism-item">
                        <div class="jb-specialism-inner clearfix" data-toggle="tooltip" title="<?php echo esc_html($term->name); ?>">
                            ...
                            <div class="jb-specialism-right">
                                <h6><?php echo esc_html($atts['length'] && strlen($term->name) > (int) $atts['length'] ? substr($term->name, 0, (int) $atts['length']) . '...' : $term->name); ?>
                                </h6>
                                <a class="jb-specialism-position"
                                    href="<?php echo esc_url($term_link); ?>"><?php echo sprintf(esc_html__('%s Positions', 'wp-recruitment'), $term->count); ?></a>
                                <a class="jb-specialism-more"
                                    href="<?php echo esc_url($term_link); ?>"><?php esc_html_e('View', 'wp-recruitment'); ?></a>
                            </div>
                        </div>
                    </div>
        ...
        <?php if (!empty($a_href)): ?>
            <div class="jb-specialism-button text-center">
                <a href="<?php echo esc_url($a_href); ?>" target="<?php echo esc_attr($a_target); ?>"><i
                        class="zmdi zmdi-chevron-down"></i><?php echo esc_html__('All Sectors', 'wp-recruitment'); ?><i
        ...
        <div class="jb-specialism-list2 col-same <?php echo esc_html($atts['custom_class']); ?> clearfix">
            ...
            <?php if (!empty($content)): ?>
                <ul class="row">
                    <?php foreach ($content as $term):
                        $term_link = get_term_link($term->term_id, 'jobboard-tax-specialisms'); ?>
                        <li class="col-lg-4 col-md-4 col-sm-6 col-xs-12"><a class="jb-specialism-more"
                                href="<?php echo esc_url($term_link); ?>"><?php echo esc_html($atts['length'] && strlen($term->name) > (int) $atts['length'] ? substr($term->name, 0, (int) $atts['length']) . '...' : $term->name); ?></a>
                        </li>
                    <?php endforeach; ?>
                    <?php if (!empty($a_href)): ?>
                        <li class="specialism-more col-lg-4 col-md-4 col-sm-6 col-xs-12"><a href="<?php echo esc_url($a_href); ?>"
                                target="<?php echo esc_attr($a_target); ?>"><?php echo esc_html__('More +', 'wp-recruitment'); ?></a>
                        </li>
                    <?php endif; ?>
                </ul>
            <?php else: ?>
                ...
                <div class="jb-specialism-list3 box-modern <?php echo esc_html($atts['custom_class']); ?> clearfix">
                    ...
                    <div class="jb-specialism-inner row">
                        ...
                        <div class="jb-specialism-view-all col-lg-3 col-md-12 col-sm-12 col-xs-12">
                            <?php if (!empty($a_href)): ?>
                                <a class="btn btn-md2" href="<?php echo esc_url($a_href); ?>"
                                    target="<?php echo esc_attr($a_target); ?>"><?php echo esc_html__('View All Sectors', 'wp-recruitment'); ?></a>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
                ...
                <div class="jb-specialism-list4 <?php echo esc_html($atts['custom_class']); ?> clearfix">
                    ...
                    <div class="jb-specialism-inner">
                        ...
                        <div class="jb-specialism-view-all">
                            <?php if (!empty($a_href)): ?>
                                <a class="btn" href="<?php echo esc_url($a_href); ?>"
                                    target="<?php echo esc_attr($a_target); ?>"><?php echo esc_html__('View All Sectors', 'wp-recruitment'); ?></a>
                            <?php endif; ?>
                        </div>
                    </div>
